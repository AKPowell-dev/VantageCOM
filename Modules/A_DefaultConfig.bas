...
Sub DefaultConfig()
    ...
    With gVim.KeyMap
        ...
        .Map "nmap bsa ToggleBorderAround -4115 2"
        .Map "nmap bsb ToggleBorderAll -4115 2"
        ...
        .Map "nmap <C-S-t> TraceErrorToRoot"
        .Map "nmap <cmd>traceerr TraceErrorToRoot"
        ...
        .Map "nmap <cmd>title CmdInsertTitle"
