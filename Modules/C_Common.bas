...
' =============================================================================
' Focus helpers – guard against cross-workbook activation/selection
' =============================================================================

Public Function IsActiveWorkbookRef(ByVal candidate As Workbook) As Boolean
    On Error Resume Next
    Dim activeWb As Workbook
    Set activeWb = Application.ActiveWorkbook
    If activeWb Is Nothing Then Exit Function
    If candidate Is Nothing Then Exit Function
    IsActiveWorkbookRef = (candidate Is activeWb)
    On Error GoTo 0
End Function

Public Function IsActiveWorkbookSheet(ByVal candidate As Worksheet) As Boolean
    On Error Resume Next
    If candidate Is Nothing Then Exit Function
    IsActiveWorkbookSheet = IsActiveWorkbookRef(candidate.Parent)
    On Error GoTo 0
End Function

Public Function IsActiveWorkbookRange(ByVal candidate As Range) As Boolean
    On Error Resume Next
    If candidate Is Nothing Then Exit Function
    IsActiveWorkbookRange = IsActiveWorkbookSheet(candidate.Worksheet)
    On Error GoTo 0
End Function

Public Sub SafeActivateWorkbook(ByVal targetWorkbook As Workbook)
    On Error Resume Next
...
Public Sub SafeSelectRange(ByVal targetRange As Range)
    On Error Resume Next
...
Public Sub SafeActivateRange(ByVal targetRange As Range)
    On Error Resume Next
    If targetRange Is Nothing Then Exit Sub
...
Private Sub JumpInner(ByVal isNext As Boolean)
    ...
    If Not gVim.JumpList Is Nothing Then
        ...
        If Not targetRange Is Nothing Then
            ...
            If IsActiveWorkbookRef(targetWorkbook) Then
                SafeSelectRange targetRange
            Else
                Call SetStatusBarTemporarily("Jump target in another workbook skipped.", 2000)
            End If
        Else
