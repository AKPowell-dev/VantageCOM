...
Private borderCycleState As Object
Private borderCycleStamp As Long
...
Private Function EnsureBorderCycleState() As Object
    If borderCycleState Is Nothing Then
        Set borderCycleState = CreateObject("Scripting.Dictionary")
    End If
    Set EnsureBorderCycleState = borderCycleState
End Function

Private Sub BorderCycleApply(ByVal key As String, ByVal index As Variant, _
                             Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
                             Optional ByVal Weight As XlBorderWeight = xlThin)
    Dim states As Object
    Dim newState As Boolean
    Set states = EnsureBorderCycleState()
    If borderCycleStamp <> gSelectionStamp Then
        states.RemoveAll
        borderCycleStamp = gSelectionStamp
    End If

    key = UCase$(key)

    If states.Exists(key) Then
        newState = Not CBool(states(key))
    Else
        newState = True
    End If
    ...
    If newState Then
        Call BorderInner(eBorderMode.BorderModeSet, index, LineStyle, Weight)
    Else
        Call BorderInner(eBorderMode.BorderModeDelete, index)
    End If
End Sub

Private Sub BorderCycleSetState(ByVal key As String, ByVal value As Boolean)
    Dim states As Object
    Set states = EnsureBorderCycleState()
    If borderCycleStamp <> gSelectionStamp Then
        states.RemoveAll
        borderCycleStamp = gSelectionStamp
    End If
    states(UCase$(key)) = value
End Sub

Private Sub BorderCycleResetKeys(ByVal keys As Variant)
    Dim states As Object
    Dim i As Long
    ...
    For i = LBound(keys) To UBound(keys)
        ...
        normalizedKey = UCase$(keys(i))
        If states.Exists(normalizedKey) Then
            states.Remove normalizedKey
        End If
    Next i
End Sub
...
Function ToggleBorderAround(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("Around", 0, LineStyle, Weight)
End Function
...
Function ToggleBorderLeft(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("Left", xlEdgeLeft, LineStyle, Weight)
End Function
...
Function ToggleBorderTop(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("Top", xlEdgeTop, LineStyle, Weight)
End Function
...
Function ToggleBorderBottom(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("Bottom", xlEdgeBottom, LineStyle, Weight)
End Function
...
Function ToggleBorderRight(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("Right", xlEdgeRight, LineStyle, Weight)
End Function
...
Function ToggleBorderInnerHorizontal(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("InsideHorizontal", xlInsideHorizontal, LineStyle, Weight)
End Function
...
Function ToggleBorderInnerVertical(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("InsideVertical", xlInsideVertical, LineStyle, Weight)
End Function
...
Function ToggleBorderInner(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("InsideBoth", Array(xlInsideHorizontal, xlInsideVertical), LineStyle, Weight)
End Function
...
Function ToggleBorderDiagonalUp(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("DiagonalUp", xlDiagonalUp, LineStyle, Weight)
End Function
...
Function ToggleBorderDiagonalDown(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("DiagonalDown", xlDiagonalDown, LineStyle, Weight)
End Function
...
Function ToggleBorderAll(Optional ByVal LineStyle As XlLineStyle = xlContinuous, _
    ...
    Call BorderCycleApply("All", Array( _
...
Function DeleteBorderAround(Optional ByVal g As String) As Boolean
    ...
    Dim resetKeys As Variant
    resetKeys = Array("Around", "Left", "Top", "Bottom", "Right")
    Call BorderCycleResetKeys(resetKeys)
End Function
...
Function DeleteBorderLeft(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("Left"))
End Function
...
Function DeleteBorderTop(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("Top"))
End Function
...
Function DeleteBorderBottom(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("Bottom"))
End Function
...
Function DeleteBorderRight(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("Right"))
End Function
...
Function DeleteBorderInnerHorizontal(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("InsideHorizontal"))
End Function
...
Function DeleteBorderInnerVertical(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("InsideVertical"))
End Function
...
Function DeleteBorderInner(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("InsideBoth"))
End Function
...
Function DeleteBorderDiagonalUp(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("DiagonalUp"))
End Function
...
Function DeleteBorderDiagonalDown(Optional ByVal g As String) As Boolean
    ...
    Call BorderCycleResetKeys(Array("DiagonalDown"))
End Function
...
Function DeleteBorderAll(Optional ByVal g As String) As Boolean
    ...
    allKeys = Array("Around", "Left", "Top", "Bottom", "Right", "InsideHorizontal", "InsideVertical", "InsideBoth", "All")
    Call BorderCycleResetKeys(allKeys)
End Function
