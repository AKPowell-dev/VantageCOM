...
public sealed class CellBorderColor : Observation
{
	public CellBorderColor(Severity sev, Range rng, int intOleColor)
		: base(Category.BrandCompliance, sev, VH.A(10480), rng)
	{
		try
		{
