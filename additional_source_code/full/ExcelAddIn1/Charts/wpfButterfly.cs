...
[DesignerGenerated]
public sealed class wpfButterfly : System.Windows.Window, IComponentConnector
{
	public Range Range;
	...
	[CompilerGenerated]
	[AccessedThroughProperty("radLabelsMiddle")]
	private RadioButton m_A;

	[AccessedThroughProperty("chkCenterLabels")]
	[CompilerGenerated]
	private System.Windows.Controls.CheckBox m_B;

	[AccessedThroughProperty("radLabelsLeft")]
	[CompilerGenerated]
	private RadioButton m_B;

	[CompilerGenerated]
	[AccessedThroughProperty("chkHideHorizAxis")]
	...
	internal virtual RadioButton radLabelsMiddle
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			RoutedEventHandler value2 = CategoryLabelPositionChanged;
	...
	internal virtual System.Windows.Controls.CheckBox chkCenterLabels
	{
		[CompilerGenerated]
		get
		{
	...
	internal virtual RadioButton radLabelsLeft
	{
		[CompilerGenerated]
		get
		{
	...
	internal virtual System.Windows.Controls.CheckBox chkHideHorizAxis
	{
		[CompilerGenerated]
		get
		{
	...
	public wpfButterfly()
	{
		base.Loaded += wpfButterfly_Loaded;
		base.Closing += wpfButterfly_Closing;
		Range = null;
		InitializeComponent();
		base.Icon = Forms.GetIcon();
	}

	private void wpfButterfly_Loaded(object sender, RoutedEventArgs e)
	{
		btnOk.Focus();
	...
	private void wpfButterfly_Closing(object sender, CancelEventArgs e)
	{
	...
	{
		Range = QuickCharts2.SampleChartData(txtAddress, Butterfly.Example);
		this.m_A = Range.Worksheet;
	}
	...
	private void CategoryLabelPositionChanged(object sender, RoutedEventArgs e)
	{
		List<string> itemsSource;
		if (radLabelsMiddle.IsChecked == true)
		{
			itemsSource = new List<string>(new string[3]
			{
				VH.A(72273),
				VH.A(72296),
				VH.A(61174)
			});
			cbxLabelPosn.ItemsSource = itemsSource;
			chkHideHorizAxis.IsChecked = true;
			chkHideHorizAxis.IsEnabled = false;
			chkCenterLabels.IsEnabled = true;
		}
		else
		{
			itemsSource = new List<string>(new string[4]
			{
				VH.A(72273),
				VH.A(72296),
				VH.A(72317),
			...
			cbxLabelPosn.ItemsSource = itemsSource;
			chkHideHorizAxis.IsEnabled = true;
			chkCenterLabels.IsEnabled = false;
		}
		cbxLabelPosn.SelectedIndex = 0;
		itemsSource = null;
	}
	...
	public void InitializeComponent()
	{
		...
		while (true)
		{
			...
			this.m_A = true;
			Uri resourceLocator = new Uri(VH.A(72340), UriKind.Relative);
		...
		if (connectionId == 8)
		{
			while (true)
			{
				...
				case 0:
					break;
				default:
					radLabelsMiddle = (RadioButton)target;
					return;
				}
			}
		}
		if (connectionId == 9)
		{
			while (true)
			{
				...
				case 0:
					break;
				default:
					chkCenterLabels = (System.Windows.Controls.CheckBox)target;
					return;
				}
			}
		}
		if (connectionId == 10)
		{
			while (true)
			{
				...
				case 0:
					break;
				default:
					radLabelsLeft = (RadioButton)target;
					return;
				}
			}
		}
		if (connectionId == 11)
		{
			while (true)
			{
				...
				case 0:
					break;
				default:
					chkHideHorizAxis = (System.Windows.Controls.CheckBox)target;
					return;
				}
			}
		}
