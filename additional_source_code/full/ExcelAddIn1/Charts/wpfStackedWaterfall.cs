...
[DesignerGenerated]
public sealed class wpfStackedWaterfall : System.Windows.Window, IComponentConnector
{
	public Range Range;
	...
	[AccessedThroughProperty("btnBridgeLine")]
	[CompilerGenerated]
	private Button m_C;
	...
	internal virtual Button btnBridgeLine
	{
		[CompilerGenerated]
		get
		{
	...
	public wpfStackedWaterfall()
	{
		base.Loaded += wpfStackedWaterfall_Loaded;
		base.Closing += wpfStackedWaterfall_Closing;
		Range = null;
		InitializeComponent();
		base.Icon = Forms.GetIcon();
	}

	private void wpfStackedWaterfall_Loaded(object sender, RoutedEventArgs e)
	{
		btnOk.Focus();
	...
	private void wpfStackedWaterfall_Closing(object sender, CancelEventArgs e)
	{
	...
	{
		Range = QuickCharts2.SampleChartData(txtAddress, StackedWaterfall.Example);
	}
	...
	public void InitializeComponent()
	{
		...
		{
			this.m_A = true;
			Uri resourceLocator = new Uri(VH.A(62648), UriKind.Relative);
