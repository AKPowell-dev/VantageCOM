...
public sealed class MissingStraightQuotes : BaseTextError
{
	public MissingStraightQuotes(Slide sld, Microsoft.Office.Interop.PowerPoint.Shape shp, TextRange2 rng)
