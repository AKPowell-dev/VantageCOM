...
public sealed class CellMarginsItem : MarginsItem
{
	public CellMarginsItem(Margins margins, List<IndexedObject> listObjects, DataTemplate template, DataTemplate navItemTemplate, int intTotal, int intIndex, string strHeader)
	...
	public override void Reformat(MarginsOption opt, ref List<string> listErrors)
	{
		...
		while (enumerator.MoveNext())
		{
			...
			try
			{
				TextFrame2 textFrame = ((Cell)indexedObject.Child).Shape.TextFrame2;
