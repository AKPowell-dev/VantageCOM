...
[DesignerGenerated]
public sealed class wpfCycleState : Window, IComponentConnector
{
	public Shape EditedShape;

	public Base.TurboShapeType TurboShapeType;

	public List<int> ShapeStates;
	...
	private void A(int A)
	{
		...
		try
		{
			...
			Base.TurboShapeType turboShapeType = TurboShapeType;
			if (turboShapeType == Base.TurboShapeType.CheckBox)
			{
				while (true)
				{
					switch (6)
	...
	public void InitializeComponent()
	{
		...
		while (true)
		{
			...
			this.m_A = true;
			Uri resourceLocator = new Uri(AH.A(159679), UriKind.Relative);
