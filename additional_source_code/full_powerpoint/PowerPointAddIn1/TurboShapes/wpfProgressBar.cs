...
[DesignerGenerated]
public sealed class wpfProgressBar : Window, IComponentConnector
{
	public Shape EditedShape;

	public List<ProgressBar.BarStyle> BarStyles;

	public ProgressBar.BarStyle CurrentBarStyle;
	...
	private void A(double A)
	{
		...
		try
		{
			...
			shape = ProgressBar.Create(slide, editedShape.Width, editedShape.Height, (float)A, CurrentBarStyle);
	...
	public void InitializeComponent()
	{
		...
		while (true)
		{
			...
			this.m_A = true;
			Uri resourceLocator = new Uri(AH.A(159955), UriKind.Relative);
