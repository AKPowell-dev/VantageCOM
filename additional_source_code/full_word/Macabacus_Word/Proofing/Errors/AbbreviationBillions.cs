...
{
	public AbbreviationBillions(Range rng, string strFix)
	...
	public AbbreviationBillions(object shp, TextRange2 rng, string strFix)
	...
	private void A(string A)
	{
		...
		Errors.AbbreviationBillions(ref val, A);
	}
