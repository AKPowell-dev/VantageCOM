...
{
	public DashSpacingUnbalanced(Range rng, string strFix)
		: base(ErrorType.Text, ((Settings)Main.Analysis.Options).PunctuationSpacingInconsistent, rng, blnHasFix: true, blnCanFixMultiple: true)
	{
		...
		Errors.DashSpacingUnbalanced(ref val, GenerateSnippet(rng));
	}

	public DashSpacingUnbalanced(object shp, TextRange2 rng, string strFix)
