...
{
	public ExtraSpaceAfterOpening(Range rng, string strFix)
		: base(ErrorType.Text, ((Settings)Main.Analysis.Options).PunctuationSpacingIncorrect, rng, blnHasFix: true, blnCanFixMultiple: true)
	{
		...
		Errors.ExtraSpaceAfterOpening(ref val, strFix, GenerateSnippet(rng));
	}

	public ExtraSpaceAfterOpening(object shp, TextRange2 rng, string strFix)
