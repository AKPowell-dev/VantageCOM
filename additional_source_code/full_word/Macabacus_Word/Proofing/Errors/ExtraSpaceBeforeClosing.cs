...
{
	public ExtraSpaceBeforeClosing(Range rng, string strFix)
		: base(ErrorType.Text, ((Settings)Main.Analysis.Options).PunctuationSpacingIncorrect, rng, blnHasFix: true, blnCanFixMultiple: true)
	{
		...
		Errors.ExtraSpaceBeforeClosing(ref val, strFix, GenerateSnippet(rng));
	}

	public ExtraSpaceBeforeClosing(object shp, TextRange2 rng, string strFix)
