...
{
	public MissingSpaceAfterClosing(Range rng, string strFix)
		: base(ErrorType.Text, ((Settings)Main.Analysis.Options).PunctuationSpacingIncorrect, rng, blnHasFix: true, blnCanFixMultiple: true)
	{
		...
		Errors.MissingSpaceAfterClosing(ref val, strFix, GenerateSnippet(rng));
	}

	public MissingSpaceAfterClosing(object shp, TextRange2 rng, string strFix)
